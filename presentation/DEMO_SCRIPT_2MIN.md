# MediGem 2-Minute Quick Overview & Demonstration Guide
...
|---|---|---|---|---|
| **0:00 - 0:25** | Intro & Problem | Hover over UI Header | *"Welcome everyone. Over 45% of rural clinics operate off-grid without internet or doctors. We built MediGem, an offline AI co-pilot powered by Google Gemma 3 4B running locally."* | MediGem Header visible with `🟢 OFFLINE FIRST` badge |
