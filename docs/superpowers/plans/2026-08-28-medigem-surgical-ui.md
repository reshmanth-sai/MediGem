...
- **Working directory is `frontend_v2/`.** All paths below are relative to it unless stated otherwise.
...
git commit -m "chore: add vitest test harness to frontend_v2"
```
...
gh pr create --title "Surgical UI overhaul for frontend_v2" --body-file -
```
